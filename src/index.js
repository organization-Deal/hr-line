  ...
  async fetch(request, env, ctx) {
    try {
      ...
      if (url.pathname === '/api/health') {
        return json({ ok: true, service: 'Nakna HR', brand: 'นากนะ', version: '1.0-P7.6', auth: 'line-first-web-setup+google' });
      }
