...
function renderPayroll(){
  ...
  if(!data){root.innerHTML='<div class="payroll-locked">Payroll แสดงเฉพาะ Owner / HR Admin / HR</div>';$('#payrollPeriods').innerHTML='';$('#payrollSettingsBtn').classList.add('hidden');$('#createPayrollPeriodBtn').classList.add('hidden');$('#payrollComponentsBtn')?.classList.add('hidden');return;}
